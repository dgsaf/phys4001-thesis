...
set ylabel "\\footnotesize LOGGY Energy [a.u.]"
...
set title sprintf("He State Energies")

# plot \
#   for [n1=in:in] for [n2=n1:n] \
#     data(n1, n2) u 1:3 ls n2 t key_state(n1, n2)

plot \
  for [n1=in:in] for [n2=n1:n] \
    data(n1, n2) u 1:(lgsc($3)) ls n2 t key_state(n1, n2)
...
str_repl = sprintf('\includegraphics{figures/he_energy/%i_%i/%is/figure}', c, n, in)
