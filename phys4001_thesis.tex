...
Hence, the Helium target pseudostates will be expressed in the form
\begin{equation}
...
the expansion.
As mentioned earlier in \autoref{sec:th-ccc-target-diag}, we restrict the first
orbital to range over a smaller set of spin orbitals,
$\lrset{\ket*{\chi_{i}^{\lr{N}}}}_{i = 1}^{2C}$ defined by the parameter $C \leq
N$, while placing no such restriction on the second orbital, yielding target
pseudostates of the form
\begin{equation}
  ...
  .
\end{equation}
Limiting the first orbital in such a manner significantly improves computational
efficiency by reducing the number of target pseudostates substantially, with
only a comparatively small reduction in accuracy.
...
% \todo[inline]{Discuss major-configuration coefficient of states as function of
%   exponential fall-off.}

% \todo[inline]{Figure of major-configuration coefficient for doubly-excited states.}

% \begin{figure}[h]
%   \begin{center}
%     \input{figures/he_mcc/2_35/1s/figure.tex}
%   \end{center}
%   \caption[...]{...}
%   % \label{fig:}
% \end{figure}
...
% \begin{figure}[h]
%   \begin{center}
%     \input{figures/he_mcc/2_35/2s/figure.tex}
%   \end{center}
%   \caption[...]{...}
%   % \label{fig:}
% \end{figure}
...
% \begin{figure}[h]
%   \begin{center}
%     \input{figures/he_energy/2_35/1s/figure.tex}
%   \end{center}
%   \caption[...]{...}
%   % \label{fig:}
% \end{figure}
...
% \begin{figure}[h]
%   \begin{center}
%     \input{figures/he_energy/2_35/2s/figure.tex}
%   \end{center}
%   \caption[...]{...}
%   % \label{fig:}
% \end{figure}
...
\begin{figure}[h]
  \begin{center}
    \input{figures/pcs/2_35/singlet/29/figure.tex}
  \end{center}
  \caption[...]{...}
  % \label{fig:}
\end{figure}
...
\begin{figure}[h]
  \begin{center}
    \input{figures/mcc/2_35/singlet/29/figure.tex}
  \end{center}
  \caption[...]{...}
  % \label{fig:}
\end{figure}
