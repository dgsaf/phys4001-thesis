...
\item[$\ket*{\Phi_{n}^{\lr{C, N}}}$ / $\epsilon_{n}^{\lr{C, N}}$]
  target (pseudostates / pseudoenergies) calculated with $C$ core states, and $N$
  one-electron basis states

\item[$\hat{I}_{T}$]
  target states projection operator
\item[$\hat{I}_{T}^{\lr{N}}$]
  target pseudostates projection operator calculated with $N$ one-electron basis
  states
...
\item[$\ket*{\Psi^{\lr{+}}}$]
  total wavefunction, with outgoing spherical-wave boundary conditions
\item[$E$]
  total energy
\item[$\ket*{\psi^{\lr{+}}}$]
  unsymmetrised total wavefunction, with outgoing spherical-wave boundary
  conditions
\item[$\ket*{F_{n}^{\lr{N}}}$]
...
\item[$\ket*{\Psi^{\lr{N, +}}}$ / $\ket*{\psi^{\lr{N, +}}}$]
  ...
  with outgoing spherical-wave boundary conditions
...
\item[$\ket*{\Omega_{\alpha}^{\lr{E}}}$ / $\varepsilon_{\alpha}^{\lr{E}}$]
  on-shell asymptotic (eigenstates / eigenenergies)
\item[$\ket*{\Phi_{n_{\alpha}}^{\lr{N}} \vb{k}_{\alpha}}$]
  asymptotic pseudostates
\item[$\hat{G}_{\lr{E}}$]
  Green's operator
\item[$\hat{G}_{\lr{E, -}}$ / $\hat{G}_{\lr{E, +}}$]
  (incoming / outgoing) Green's operator
\item[$\hat{T}$]
  the $\hat{T}$ operator
\item[$\hat{K}$]
  the $\hat{K}$ operator
