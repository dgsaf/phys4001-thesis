...
\begin{equation}
  ...
  .
\end{equation}
Limiting the selection of Slater determinants in such a manner significantly
improves computational efficiency by reducing the number of target pseudostates
substantially, at the cost of comparatively minor reductions in the accuracy of
the target pseudostates.
...
configuration of a particular target pseudostate, and we say that the associated
expansion coefficient is the major configuration coefficient.
