...
This is to say, that the CCC calculations for the ionisation-with-excitation
cross sections are not inherently inaccurate, but can be easily corrupted by a
poorly behaved basis of one-electron atomic orbitals.
...
the ionisation-without-excitation cross section.
The second would be to proceed with the CCC method as usual, but to additionally
create a set of pure target pseudostates by other means, and then to perform a
basis transformation between the mixed and pure sets of target pseudostates, yielding
