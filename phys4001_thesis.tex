...
While a few of these cross sections do infact demonstrate a level of agreement
...
\begin{equation*}
  ...
  .
\end{equation*}
The doubly-excited states of helium do infact have energies which are contained
within the continuum of energies associated with ionised-without-excitation
states of helium, and hence it is possible to have distinct target pseudostates
with near equal pseudoenergies.
...
configurations with continuum orbitals to continuously shift also, while the
discrete configurations would remain constant.
Consequently, we should expect various pairs of ionisied-without-excitation and
doubly-excited target pseudostates to overlap in energy as $\lambda$ is
adjusted, and thus the mixing of these pairs of pseudostates.
